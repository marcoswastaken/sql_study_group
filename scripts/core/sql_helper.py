...
class SQLHelper:
    ...
    def execute_query(
        self, query: str, exercise_number: Optional[int] = None
    ) -> Dict[str, Any]:
        """
    ...
    def run_exercise(
        self, query: str, exercise_number: int, max_rows: int = 100
    ) -> Dict[str, Any]:
        """
...
def run_sql(
    query: str, exercise_number: int = None, max_rows: int = 100
) -> Dict[str, Any]:
    """
